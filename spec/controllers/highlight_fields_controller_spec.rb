...
describe HighlightFieldsController, :type => :controller do
  ...
  describe "show" do
    ...
    it "should have highlighted fields assigned" do
      ...
      FormSection.new(:name => "Section1", :unique_id => "section1", :fields => [field1])
      FormSection.new(:name => "Section2", :unique_id => "section2", :fields => [field2])
      FormSection.new(:name => "Section3", :unique_id => "section3", :fields => [field3])
      form = double("Form")
