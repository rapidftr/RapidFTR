...
describe 'enquiries/show.html.erb', :type => :view do
  ...
  describe 'rendering matching child partial' do
    it 'should a have link to mark child as not a match' do
      ...
      render :template => 'children/_summary_row', :locals => {:child => child, :enquiry => @enquiry, :checkbox => false, :highlighted_fields => fields, :rendered_by_show_enquiry => true, :confirmed_match => nil}
