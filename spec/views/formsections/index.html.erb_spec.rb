...
describe "form_section/index.html.erb" do
  ...
  before :each do
    @form_section_1  = FormSectionDefinition.new "name" => "Basic Details", "enabled"=> "true" , "description"=>"Blah blah", "order"=>"10", "unique_id"=> "basic_details"
    @form_section_2  = FormSectionDefinition.new "name" => "Caregiver Details", "enabled"=> "false", "order"=>"101", "unique_id"=> "caregiver_details"
