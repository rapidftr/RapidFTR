...
describe "home/index.html.erb" do
  it "should display time for notifications in yyyy/mm/dd format for users who do not already exist" do
    mock_password_recovery_request = mock("PasswordRecoveryRequest", :user_name =>'mjhasson', :created_at => Time.parse("Jan 31 2011"), :to_param => '123')
  ...
  it "should display time for notifications in yyyy/mm/dd format for users who do exist" do
    mock_password_recovery_request = mock("PasswordRecoveryRequest", :user_name =>'jpretorius', :created_at => Time.parse("Jan 31 2011"), :to_param => '124')
    assign(:notifications, [ mock_password_recovery_request ])
