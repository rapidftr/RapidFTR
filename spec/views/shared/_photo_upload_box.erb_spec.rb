...
describe 'shared/_photo_upload_box.html.erb', :type => :view do
  before :each do
  ...
  it 'should include image for tooltip when help text exists' do
    ...
    render :partial => 'shared/photo_upload_box', :locals => {:photo_upload_box => photo_upload_box, :model => @child}, :formats => [:html], :handlers => [:erb]
