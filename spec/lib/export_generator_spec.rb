  ...
  describe "when generating a CSV download" do
    describe "with just a name field" do
      ...
      it 'should have a photo column with appropriate links' do
        ...
        csv_data = FasterCSV.parse subject.data
        csv_data[1][3].should == "http://testmachine:3000/children/3-123451/photo/photo-some-id-1"
        csv_data[2][3].should == "http://testmachine:3000/children/4-153213/photo/photo-some-id-2"
        csv_data.length.should == 3
      end
      ...
      it 'should have an audio column with appropriate links' do
        ...
        csv_data = FasterCSV.parse subject.data
        csv_data[1][3].should == "http://testmachine:3000/children/3-123451/audio"
        csv_data[2][3].should == "http://testmachine:3000/children/4-153213/audio"
        csv_data.length.should == 3
      end
    end
