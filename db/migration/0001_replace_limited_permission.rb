...
if field_worker
  role = Role.new(:name => "field worker", :permissions => [Permission::CHILDREN[:register]]).save!
...
if field_admin
  role = Role.new(:name => "field admin", :permissions => [Permission::CHILDREN[:access_all_data]]).save!
