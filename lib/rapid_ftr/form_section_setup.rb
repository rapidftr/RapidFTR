  ...
  module FormSectionSetup
    ...
    def self.reset_definitions
      ...
      basic_identity_fields = [
        ...
        Field.new("name" => "names_origin", "display_name" => "Name(s) given to child after separation?", "type" => "select_box", "option_strings_text" => "Yes\nNo"),
      ...
      unless Rails.env.test? or Rails.env.cucumber?
        family_details_fields = [
          ...
          Field.new("name" => "is_father_alive", "display_name" => "Is Father Alive?", "type" => "select_box", "option_strings_text" => "Unknown\nAlive\nDead"),
          ...
          Field.new("name" => "is_mother_alive", "display_name" => "Is Mother Alive?", "type" => "select_box", "option_strings_text" => "Unknown\nAlive\nDead"),
          ...
          Field.new("name" => "is_caregiver_alive", "display_name" => "Is Caregiver Alive?", "type" => "select_box", "option_strings_text" => "Unknown\nAlive\nDead"),
        ...
        current_arrangements_fields = [
          ...
          Field.new("name" => "care_arrangements_knowsfamily", "display_name" => "Does the caregiver know the family of the child?", "type" => "select_box", "option_strings_text" => "Yes\nNo"),
        ...
        separation_history_fields = [
          ...
          Field.new("name" => "evacuation_status", "display_name" => "Has child been evacuated?", "type" => "select_box", "option_strings_text" => "Yes\nNo"),
        ...
        protection_concerns_fields = [
          Field.new("name" => "concerns_chh", "display_name" => "Child Headed Household","type" => "select_box", "option_strings_text" => "Yes\nNo"),
      	  Field.new("name" => "concerns_disabled", "display_name" => "Disabled Child","type" => "select_box", "option_strings_text" => "Yes\nNo"),
      	  Field.new("name" => "concerns_medical_case", "display_name" => "Medical Case","type" => "select_box", "option_strings_text" => "Yes\nNo"),
      	  Field.new("name" => "concerns_street_child", "display_name" => "Street Child", "type" => "select_box", "option_strings_text" => "Yes\nNo"),
      	  Field.new("name" => "concerns_girl_mother", "display_name" => "Girl Mother", "type" => "select_box", "option_strings_text" => "Yes\nNo"),
      	  Field.new("name" => "concerns_vulnerable_person", "display_name" => "Living with Vulnerable Person", "type" => "select_box", "option_strings_text" => "Yes\nNo"),
      	  Field.new("name" => "concerns_abuse_situation", "display_name" => "Girl Mother", "type" => "select_box", "option_strings_text" => "Yes\nNo"),
        ...
        child_wishes_fields = [
          ...
          Field.new("name" => "wishes_contacted", "display_name" => "Has the child heard from / been in contact with any relatives?", "type" => "select_box", "option_strings_text" => "Yes\nNo"),
        ...
        interview_details_fields = [
          ...
          Field.new("name" => "disclosure_public_photo", "display_name" => "Photo?", "type" => "select_box", "option_strings_text" => "Yes\nNo"),
          Field.new("name" => "disclosure_public_relatives", "display_name" => "Names of Relatives?", "type" => "select_box", "option_strings_text" => "Yes\nNo"),
          Field.new("name" => "disclosure_other_orgs", "display_name" => "Does Child/Caregiver agree to share collected information with other organizations?", "type" => "select_box", "option_strings_text" => "Yes\nNo"),
          Field.new("name" => "disclosure_authorities", "display_name" => "The authorities?", "type" => "select_box", "option_strings_text" => "Yes\nNo"),
          ...
          Field.new("name" => "interview_subject", "display_name" => "Information Obtained From", "type" => "select_box", "option_strings_text" => "the child\ncaregiver\nother"),
      ...
      if Rails.env.android?
        automation_form_fields =[
           ...
           Field.new("display_name" => "Automation CheckBoxes", "type" =>"check_boxes" ,"option_strings_text" => "Check 1\nCheck 2\nCheck 3") ,
           Field.new("display_name" => "Automation Select", "type" => "select_box","option_strings_text" => "Select 1\nSelect 2\nSelect 3"),
           Field.new("display_name" => "Automation Radio", "type" => "radio_button","option_strings_text" => "Radio 1\nRadio 2\nRadio 3"),
