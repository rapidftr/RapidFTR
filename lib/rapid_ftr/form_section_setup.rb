  ...
  module FormSectionSetup
    ...
    def self.reset_definitions
      ...
      basic_details_fields = [
              ...
              Field.new("name" => "childs_photo", "display_name" => "Child's photo", "type" => "photo_upload_box"),
      ...
      family_details_fields = [
              ...
              Field.new("name" => "fathers_photo", "display_name" => "Father's photo", "type" => "photo_upload_box"),
              ...
              Field.new("name" => "mothers_photo", "display_name" => "Mothers's photo", "type" => "photo_upload_box"),
              ...
              Field.new("name" => "relative_1_photo", "display_name" => "Relative 1's photo", "type" => "photo_upload_box"),
              ...
              Field.new("name" => "relative_2_photo", "display_name" => "Relative 2's photo", "type" => "photo_upload_box"),
              ...
              Field.new("name" => "relative_3_photo", "display_name" => "Relative 3's photo", "type" => "photo_upload_box"),
              ...
              Field.new("name" => "relative_4_photo", "display_name" => "Relative 4's photo", "type" => "photo_upload_box"),
