  ...
  class DbSetup
    ...
    def self.reset_default_form_section_definitions
      ...
      family_details_fields = [
              Field.new("name" => "father_name", "type" => "text_field"),
              Field.new("name" => "is_father_alive", "type" => "radio_button", "option_strings" => ["Yes", "No", "Unknown"]),
              Field.new("name" => "reunite_with_father", "type" => "check_box"),
              Field.new("name" => "mother_name", "type" => "text_field"),
              Field.new("name" => "is_mother_alive", "type" => "radio_button", "option_strings" => ["Yes", "No", "Unknown"]),
              Field.new("name" => "reunite_with_mother", "type" => "check_box"),
              ...
              Field.new("name" => "reunite_with_relative_1", "type" => "check_box"),
              ...
              Field.new("name" => "reunite_with_relative_2", "type" => "check_box"),
              ...
              Field.new("name" => "reunite_with_relative_3", "type" => "check_box"),
              ...
              Field.new("name" => "reunite_with_relative_4", "type" => "check_box"),
              Field.new("name" => "married", "type" => "check_box"),
