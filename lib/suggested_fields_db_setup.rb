module RapidFTR
  ...
  class SuggestedFieldsDbSetup
    ...
    def self.recreate_suggested_fields
      ...
      create_field!("Date of separation", "When the child was separated from his/her parents", "date_of_separation",  "select_drop_down", ["", "1-2 weeks ago", "2-4 weeks ago", "1-6 months ago", "6 months to 1 year ago", "More than 1 year ago"])
