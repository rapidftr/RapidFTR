module ChildrenHelper
  ...
  def history_entry_for history, field, change
    if field == "photo_keys"
      return {:partial => "photo_history_change",
              :locals =>{
