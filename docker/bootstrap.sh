...
apt-get update
$minimal_apt_get_install build-essential git libxml2-dev libxslt1-dev zlib1g-dev imagemagick openjdk-7-jre-headless uuid-runtime couchdb nodejs imagemagick libmagickcore-dev libmagickwand-dev
