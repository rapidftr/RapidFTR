Feature: Viewing child records
  ...
  Scenario: Date-times should be displayed according to the current user's timezone setting.
    ...
    And I follow "Edit"
    And I fill in "28" for "Age"
    And I press "Save"

    Then I should see "Registered by: zubair and others on 2010-07-19 02:05:32 -1100"
    And I should see "Last updated: 2010-03-01 06:59:33 -1100"
